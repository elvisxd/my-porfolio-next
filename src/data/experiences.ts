...
export const experiences: WorkExperience[] = [
  ...
  },
  {
    ...
    responsibilities: [
      {
        id: uuidv4(),
        text: "Order Filler, Loader, and Lift Driver.",
      },
      {
        id: uuidv4(),
        text: "Responsible for moving pallets with a forklift, loading and unloading trucks with merchandise for distribution.",
      },
      {
        id: uuidv4(),
        text: "Additionally, tasked with replacing slots with new pallets and ensuring the workspace is clean and safe for free transit.",
      },
      {
        id: uuidv4(),
        text: "Volunteered for the hazmat team.",
      },
    ],
    technologies: [
